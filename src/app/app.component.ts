...
export class AppComponent {
  ...
  audreyWords = ['start', 'bdp', 'bd', 'bde', 'sj', 'bl', 'lbl', 'chd', 'msd', 'cmd', 'lmd', 'csd', 'dl', 'dlg', 'gi5', 'gl', 'rl', 'lol', 'pl', 'pyl', 'sdjw', 'rts', 'sup', 'sxr', 'rr', 'pp', 'tgt', 'tbs', 'twd', 'tjg', 'wsdr', 'wsds', 'wre', 'cws', 'w4c', 'w4cb', 'w4cf', 'w4cp', 'w4cw'];
